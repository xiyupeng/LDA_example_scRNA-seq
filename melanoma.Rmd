...
for(i in 1:length(patients)){
  ...
  ini_clusters<-c(ini_clusters,(i-1)*100+tmp$map$mapping[, 1])  ## cluster labels (need renamed)
...
## The algorithm will return all results with different K, from 2 to the maximum.
K<- 30 
## Consensus clustering. If you have few samples, you can also use the default hierarchical clustering algorithm with clusterAlg="hc"
