...
Here we present our whole workflow for analyzing longitudinal flow cytometry data from a large cohort study (Starting from FCS file to figures in the manuscript).
The study includes 1 clinical trial of 51 melanoma patients who underwent immune checkpoint blockade treatment (ICI) with nivolumab and ipilimumab.
...
Rcodes for key steps in pre-gating process.
(working in progress)


```{r, eval = FALSE}
# 2023-05-02 JLEE added this chunk 
...
path_biexp_params = params$path_biexp_params

# Example of what the above parameters could look like
  # pt_samp_nm = "17-162-08A"
  # 
  # ## File path to the FCS file
  # path_fcs = here::here("PICI/17-162_rerun_fixed_transf/LDA_examples/test_run/17-162-08_A_015.fcs")
  # 
  # ## File path to the compensation matrix csv file
  # ## Expect format to match flowJo exported version
  # path_comp_mat = here::here("PICI/17-162_rerun_fixed_transf/LDA_examples/test_run/17-162-08.csv")
  # 
  # ## File path for outputs/saving
  # path_out = here::here("PICI/17-162_rerun_fixed_transf/LDA_examples/test_run")
  # 
  # ## File path to gating template
  # gtFile = here::here("PICI/gating_template/x50_tcell_up_to_cd3_LDA_paper.csv")
  # 
  # ## File path to biexp parameters
  # ## Expects 4 columns: full_name, ext_neg_dec, width_basis, positive_dec
  # ## full name should contain the channel/dye name
  # #3 remaining cols fill in with desired parameter values
  # path_biexp_params = here::here("PICI/biexp_transformation_parameters/biexp_transf_parameters_X50.xlsx")
...
## **XP-- do we want to show preview of gating template ?
...
# **XP -- do we want preview of comp mat here?
# comp.mat %>%
#   head
...
## **XP - more checks, can choose to remove or comment out
## Checks that all channels have a matching biexpTrans object
# lapply(biexpTrans, 
...
## **XP -- optional , can comment out
# ## Check the values before transformation
# gs %>% 
#   gh_pop_get_data() %>% 
#   summary()
...
## **XP- optional can comment out
## Check values after transformation
# gs %>% 
#   gh_pop_get_data() %>% 
#   summary()
