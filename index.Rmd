---
title: "Exploring the heterogeneity in single-cell data with topic modeling"
author: "Xiyu Peng"
date: "Jan 2023"
---
...
LDA is also flexible enough to be embedded in more complex models for inference, e.x. structural topic model, dynamic topic model, hieirarchical topic model, etc.
...
This website shows examples of applications of Latent Dirichlet Allocation (LDA) model on different types of single-cell datasets.
