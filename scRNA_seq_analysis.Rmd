...
```{r}
metadata.sel.count_tumor_tissue <- read.csv("~/flow_cytometry/manuscript/liver cancer data/metadata-sel-count_tumor_tissue.csv")
...
rownames(metadata.sel.count_tumor_tissue)<-metadata.sel.count_tumor_tissue$X
metadata.sel.count_tumor_tissue<-as.data.frame(metadata.sel.count_tumor_tissue[,-1])
